            ...
            locations.forEach(loc => {
              ...
              if (!markers[loc.id]) {
                ...
                markers[loc.id].markerObject.addListener('click', function (p) {
                  // content for the report tooltip
                  let content                          = ''
                  ...
                  if  (loc.reporter_username) content += '<div class="marker-tt-reporter">Reported by: ' + loc.reporter_username + '</div>'

                    // Add voting section
                  content += '<div id="vote-container-' + loc.id + '" class="vote-container"></div>'
